...
public class Recipes 
{
	public static void init()
	{
		...
		GameRegistry.addRecipe(new ItemStack(BleachBlocks.paperwall, 8), new Object[]{
			...
			'*', BleachItems.soulcloth, '#', Items.stick
		});
		//Soul Cloth
		...
		GameRegistry.addRecipe(new ItemStack(BleachItems.maskshard, 3), new Object[]{"*", '*', BleachItems.menosmask});
			...
			GameRegistry.addRecipe(new ItemStack(BleachItems.soulsteel, 1), new Object[]{
				...
				'*', BleachItems.reiatsu, '#', Items.iron_ingot
			});
			//Quincy Cross
			...
			GameRegistry.addRecipe(new ItemStack(BleachBlocks.paperLamp, 2), new Object[]{
				...
				"***",
					...
					'&', BleachItems.soulcloth, '#', Blocks.torch, '*', Items.paper
				});
			
			//Hollow Book
			GameRegistry.addShapelessRecipe(new ItemStack(BleachItems.hollowbook, 1), new Object[]{
					new ItemStack(BleachItems.maskshard), new ItemStack(Items.book)
				});
				//Shinigami Armor
				...
				GameRegistry.addRecipe(new ItemStack(Armor.QuincyRobe, 1), new Object[]{
					...
					'*', BleachItems.soulcloth, '#', Blocks.lapis_block
				});
