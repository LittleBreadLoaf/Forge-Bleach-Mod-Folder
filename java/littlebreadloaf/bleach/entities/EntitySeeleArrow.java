...
public class EntitySeeleArrow extends Entity implements IProjectile
{
	...
	public EntitySeeleArrow(World var1)
	{
		super(var1);
	...
	public EntitySeeleArrow(World var1, double var2, double var4, double var6)
	{
		super(var1);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public EntitySeeleArrow(World var1, EntityLiving var2, EntityLiving var3, float var4, float var5)
	{
		super(var1);
		this.renderDistanceWeight = 10.0D;
	...
	public EntitySeeleArrow(World var1, EntityLivingBase var2, float var3)
	{
		super(var1);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = var2;
		...
		for (int ar5 = -1; ar5 <= 1; ++ar5)
		{
			for (int ar6 = -1; ar6 <= 1; ++ar6)
			{
				for (int ar7 = -2; ar7 <= 0; ++ar7)
				{
					...
					int ar9 = ar1 + ar7;
					int ar10 = ar3 + ar6;
					Block ar11 = this.worldObj.getBlock(ar8, ar9, ar10);
					int ar12;

					if (ar11 != null && (ar11 == Blocks.cactus || ar11 == Blocks.carrots || ar11 == Blocks.wheat || ar11 == Blocks.deadbush
							|| ar11 == Blocks.cocoa || ar11 == Blocks.ice || ar11 == Blocks.leaves || ar11 == Blocks.leaves2
							|| ar11 == Blocks.brown_mushroom_block || ar11 == Blocks.melon_stem || ar11 == Blocks.potatoes 
							|| ar11 == Blocks.pumpkin_stem || ar11 == Blocks.red_mushroom_block || ar11 == Blocks.reeds
							|| ar11 == Blocks.snow_layer || ar11 == Blocks.vine || ar11 == Blocks.waterlily || ar11 == Blocks.web 
							|| ar11 == Blocks.brown_mushroom || ar11 == Blocks.yellow_flower || ar11 == Blocks.tallgrass 
							|| ar11 == Blocks.red_mushroom || ar11 == Blocks.red_flower))
					{
						ar12 = this.worldObj.getBlockMetadata(ar8, ar9, ar10);
						this.worldObj.setBlockToAir(ar8, ar9, ar10);

					}
							if (ar11 != null && ar11 == Blocks.grass)
					{
						ar12 = this.worldObj.getBlockMetadata(ar8, ar9, ar10);
						this.worldObj.setBlock(ar8, ar9, ar10, Blocks.dirt, 0, 0);
					}
				...
				if (var4.entityHit != null)
				{
					if (var4.entityHit instanceof EntityLivingBase)
					{
						if (((EntityLivingBase) var4.entityHit).getCreatureAttribute() == Tools.SPIRIT)
						{
							...
							((EntityLivingBase) var4.entityHit).setHealth(((EntityLivingBase) var4.entityHit).getHealth() - 20);

						}

					}
					if(!worldObj.isRemote)
					worldObj.createExplosion(this, this.posX, this.posY, this.posZ, 1, this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"));
					this.ticksInAir = 495;
					if (!worldObj.isRemote)
					{
						this.dropItem(BleachItems.seele, 1);
