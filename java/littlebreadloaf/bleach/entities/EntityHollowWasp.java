...
public class EntityHollowWasp extends EntityMob
{
	...
	public void onUpdate()
	{
		...
		this.motionX += (Math.signum(d0) * 0.5D - this.motionX) * 0.070000000149011612D;
		this.motionY += (Math.signum(d1) * 0.699999988079071D - this.motionY) * 0.070000000149011612D;
		this.motionZ += (Math.signum(d2) * 0.5D - this.motionZ) * 0.070000000149011612D;
