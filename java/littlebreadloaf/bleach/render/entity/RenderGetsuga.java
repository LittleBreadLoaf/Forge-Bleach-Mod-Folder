...
{
	private static final ResourceLocation field_110780_a = new ResourceLocation(BleachModInfo.ID.toLowerCase() + ":textures/items/getsugaarrows.png");
	...
	public void renderGetsuga(EntityGetsuga par1EntityGetsuga, double par2, double par4, double par6, float par8, float par9)
	{
		...
		float f11 = (float) par1EntityGetsuga.arrowShake - par9;
