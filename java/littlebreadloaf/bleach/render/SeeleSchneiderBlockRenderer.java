...
public class SeeleSchneiderBlockRenderer extends TileEntitySpecialRenderer
{
	...
	public SeeleSchneiderBlockRenderer()
	{
		...
		this.TEXTURE_MODEL = new ResourceLocation(BleachModInfo.ID + ":models/SeeleSchneider.obj");
		this.TEXTURE_BLADE = new ResourceLocation(BleachModInfo.ID + ":models/SeeleSchneider_Blade.obj");
