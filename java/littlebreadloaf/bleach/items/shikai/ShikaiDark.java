...
public class ShikaiDark extends ItemSword
{
	...
	public ShikaiDark(ToolMaterial material) 
	{
		super(material);
	...
	@Override
    /**
     * Current implementations of this method in child classes do not use the entry argument beside evThey just raise
    ...
    public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase)
    {
        ...
        float damage = this.damageBoost + this.sandalboost + this.pantboost + this.robeboost + this.darkboost;
...
@Override
    /**
     * called when the player releases the use item buttonArgs: itemstack, world, entityplayer, itemInUseCount
     */
