...
public class ShikaiFire extends ItemSword
{
	...
	public ShikaiFire(ToolMaterial material) 
	{
		super(material);
...
public void onPlayerStoppedUsing(ItemStack var1, World var2, EntityPlayer var3, int var4)
{
    ...
    if (var7 > 1.0F)
    {
        ...
        if(!var2.isRemote)
        {
        	EntitySmallFireball Fireball = new EntitySmallFireball(var2, var3, 5*Math.cos(-var3.rotationPitch * (Math.PI / 180F))*Math.sin(-var3.rotationYaw * (Math.PI / 180F)), 5*Math.sin(-var3.rotationPitch * (Math.PI / 180F)), 5*Math.cos(-var3.rotationPitch * (Math.PI / 180F))*Math.cos(-var3.rotationYaw * (Math.PI / 180F)));
