...
public class TileSeeleSchneider extends TileBleach
{
	...
	public void checkForShape()
	{
		...
		for (int x = 3; x <= 16; x++)
		{
			if (worldObj.getBlock(xCoord + x, yCoord, zCoord) == BleachBlocks.seeleSchneiderBlock
					&& worldObj.getBlock(xCoord, yCoord, zCoord + x) == BleachBlocks.seeleSchneiderBlock
					&& worldObj.getBlock(xCoord + x, yCoord, zCoord + x) == BleachBlocks.seeleSchneiderBlock)
			{
				...
				this.setMain(x);
				return;
			} else if (worldObj.getBlock(xCoord - x, yCoord, zCoord) == BleachBlocks.seeleSchneiderBlock
					&& worldObj.getBlock(xCoord, yCoord, zCoord - x) == BleachBlocks.seeleSchneiderBlock
					&& worldObj.getBlock(xCoord - x, yCoord, zCoord - x) == BleachBlocks.seeleSchneiderBlock)
			{
				...
				TileSeeleSchneider tile = (TileSeeleSchneider) worldObj.getTileEntity(xCoord - x, yCoord, zCoord - x);
				tile.setMain(x);
				return;
					...
					&& worldObj.getBlock(xCoord - x, yCoord, zCoord + x) == BleachBlocks.seeleSchneiderBlock)
			{
				...
				TileSeeleSchneider tile = (TileSeeleSchneider) worldObj.getTileEntity(xCoord - x, yCoord, zCoord);
				tile.setMain(x);
				return;
			} else if (worldObj.getBlock(xCoord + x, yCoord, zCoord) == BleachBlocks.seeleSchneiderBlock
					&& worldObj.getBlock(xCoord, yCoord, zCoord - x) == BleachBlocks.seeleSchneiderBlock
					&& worldObj.getBlock(xCoord + x, yCoord, zCoord - x) == BleachBlocks.seeleSchneiderBlock)
			{
				...
				TileSeeleSchneider tile = (TileSeeleSchneider) worldObj.getTileEntity(xCoord, yCoord, zCoord - x);
				tile.setMain(x);
				return;
			}
		}
