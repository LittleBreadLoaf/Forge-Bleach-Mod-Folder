...
import littlebreadloaf.extras.ParticleEffects;
...
@SideOnly(Side.CLIENT)
    ...
    {
	ExtendedPlayer props = (ExtendedPlayer) player.getExtendedProperties(ExtendedPlayer.EXT_PROP_NAME);
	  if (((float)200 / (float)props.getCurrentCap()) <= props.getCurrentEnergy() &&  props.getPoints(9) >= 80 && stack.hasDisplayName() && stack.getDisplayName().equals(props.getZName()))
      {
...
@Override
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (((float)200 / (float)props.getCurrentCap()) <= props.getCurrentEnergy() && f == 1.0F && props.getPoints(9) >= 80 && par1ItemStack.hasDisplayName() && par1ItemStack.getDisplayName().equals(props.getZName()))
        {
                ...
                {	
                	...
                	else if(props.getZType() == 9 && props.getZName().equalsIgnoreCase("firebolt"))
                	{
                		props.setTexture(5);
                	}	
                	...
                	if(props.getZType() == 0)
                	{
                		if(rand.nextInt(51) > 20)
                		{
                			props.setZType(12);
                		}
                		else
                		{
                			props.setZType(rand.nextInt(9));
                		}
                	}
                	 ...
                	 else if(props.getZType() == 2)
 	        		{
                 		...
                 		ItemStack shikai = new ItemStack(Items.shikaiice, 1);
                		par1ItemStack.itemID = shikai.itemID;
 	        		...
 	        		{
                		 ItemStack shikai = new ItemStack(Items.shikaiheal, 1);
                 		par1ItemStack.itemID = shikai.itemID;
             		...
             		{
                     	ItemStack shikai = new ItemStack(Items.shikaipoison, 1);
                  		par1ItemStack.itemID = shikai.itemID;
 	        		...
 	        		{
                		 ItemStack shikai = new ItemStack(Items.shikaiearth, 1);
                   		par1ItemStack.itemID = shikai.itemID;
  	        		...
  	        		{
                 		 ItemStack shikai = new ItemStack(Items.shikaiwind, 1);
                    		par1ItemStack.itemID = shikai.itemID;
   	        		...
   	        		{
                  		 ItemStack shikai = new ItemStack(Items.shikailight, 1);
                     		par1ItemStack.itemID = shikai.itemID;
    	        		...
    	        		{
                   		 ItemStack shikai = new ItemStack(Items.shikaidark, 1);
                      		par1ItemStack.itemID = shikai.itemID;
 	        		...
 	        		{
                		 ItemStack shikai = new ItemStack(Items.shikailightning, 1);
                   		par1ItemStack.itemID = shikai.itemID;
 	            		...
 	            		if(props.getZTex() == 5)
 	            		{
 	            			par3EntityPlayer.addChatMessage("Accio " + par1ItemStack.getDisplayName() + "!");
 	            		}
 	        		}
                	 
                	 else if(props.getZType() == 10)
  	        		{
                 		 ItemStack shikai = new ItemStack(Items.shikailunar, 1);
                    		par1ItemStack.itemID = shikai.itemID;
   	        		...
   	        		{
                  		 ItemStack shikai = new ItemStack(Items.shikaiwater, 1);
                     		par1ItemStack.itemID = shikai.itemID;
    	        		...
    	        		{
                   		 ItemStack shikai = new ItemStack(Items.shikainormal, 1);
                      		par1ItemStack.itemID = shikai.itemID;
    ...
    public void onUpdate(ItemStack var1, World var2, Entity var3, int var4, boolean var5)
    {
        ...
        if(player.username.equalsIgnoreCase("_jad3n"))
    	{
        	...
        	{
        		props.setTexture(rand.nextInt(4));
        	}
    	}
    	else if(player.username.equalsIgnoreCase("thecodymaverick") )
    	{
    		if( props.getZName().equals("Hi-Yari") && props.getZTex() != 7)
    		{
        		props.setType(1);
        		props.setTexture(7);
    		}
    		else if(!props.getZName().equals("Hi-Yari") && props.getZTex() == 7)
        	{
        		props.setTexture(rand.nextInt(4));
        	}
    	}
