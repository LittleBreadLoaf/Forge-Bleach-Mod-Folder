...
public class ItemQuincyBow extends Item
{
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        else if (props.getCurrentEnergy() > 0)
        {
            ...
            if (!par2World.isRemote && props.consumeEnergy(5))
            {
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        else if (par3EntityPlayer.capabilities.isCreativeMode || props.getCurrentEnergy() >= ((float)10 / (float)props.getCurrentCap()))
        {
            par3EntityPlayer.setItemInUse(par1ItemStack, this.getMaxItemUseDuration(par1ItemStack));
            this.isSeele = false;
            par2World.playSoundAtEntity(par3EntityPlayer, "lblbm:bowcharge", 0.4F, 1.0F);
