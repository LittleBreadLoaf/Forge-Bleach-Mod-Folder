...
public class ShikaiDark extends Item
{
	...
	public ShikaiDark(int id, EnumToolMaterial material) 
	{
		super(id);
    ...
    {
		return this.weaponDamage + this.damageBoost + this.robeboost + this.pantboost + this.sandalboost + this.darkboost;
