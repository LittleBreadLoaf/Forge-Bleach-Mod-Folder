...
public class ShikaiIce extends Item
{
    ...
    {
		return this.weaponDamage + this.damageBoost + this.robeboost + this.pantboost + this.sandalboost + this.coldboost;
...
@Override
    ...
    public void onUpdate(ItemStack var1, World var2, Entity var3, int var4, boolean var5)
    {
    	...
    	ItemStack var12 = new ItemStack(Items.zanpakuto, 1);
