...
public class ShikaiLightning extends Item
{
    ...
    public boolean hitEntity(ItemStack par1ItemStack, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase)
    {
        ...
        EntityLightningBolt var100 = new EntityLightningBolt(player.worldObj, par2EntityLivingBase.posX, par2EntityLivingBase.posY, par2EntityLivingBase.posZ + 4 );
    ...
    public void onPlayerStoppedUsing(ItemStack var1, World var2, EntityPlayer var3, int var4)
    {
        ...
        if (var7 > 1.0F)
        {
            var7 = 1.0F;
            		...
            		EntityLightningBolt var8 = new EntityLightningBolt(var2, var3.posX + 4, var3.posY, var3.posZ );
            		var2.addWeatherEffect(var8);
                    EntityLightningBolt var9 = new EntityLightningBolt(var2, var3.posX - 4, var3.posY, var3.posZ );
                    var2.addWeatherEffect(var9);
                
                    EntityLightningBolt var10 = new EntityLightningBolt(var2, var3.posX, var3.posY, var3.posZ + 4 );
                    var2.addWeatherEffect(var10);
                    EntityLightningBolt var11 = new EntityLightningBolt(var2, var3.posX, var3.posY, var3.posZ - 4 );
                    var2.addWeatherEffect(var11);
            if(!var2.isRemote)
            {
