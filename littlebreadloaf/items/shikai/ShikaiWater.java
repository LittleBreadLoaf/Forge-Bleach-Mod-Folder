...
public class ShikaiWater extends Item
{
	...
	public float waterboost = 0;
	public float rainboost = 0;
    ...
    {
		return this.weaponDamage + this.damageBoost + this.robeboost + this.pantboost + this.sandalboost + this.waterboost + this.rainboost;
    ...
    public void onUpdate(ItemStack var1, World var2, Entity var3, int var4, boolean var5)
    {
    	...
    	if(var6.getCurrentEquippedItem() == var1)
    	{
    		if(var6.isInWater())
    		{
    			var6.moveFlying(var6.moveStrafing, var6.moveForward, 0.05F);
    		}
    	}
    }
