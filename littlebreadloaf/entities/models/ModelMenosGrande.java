...
public class ModelMenosGrande extends ModelBase
{
    ...
    public void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, Entity var7)
    {
        ...
        this.righttoe1.rotateAngleX = MathHelper.cos(var1 * 0.6662F) * 1.4F * var2;
        this.righttoe1.rotateAngleY = 0.0F;
        this.lefttoe1.rotateAngleX = MathHelper.cos(var1 * 0.6662F + (float)Math.PI) * 1.4F * var2;
        this.lefttoe1.rotateAngleY = 0.0F;
        this.righttoe2.rotateAngleX = MathHelper.cos(var1 * 0.6662F) * 1.4F * var2;
        this.righttoe2.rotateAngleY = 0.0F;
        this.lefttoe2.rotateAngleX = MathHelper.cos(var1 * 0.6662F + (float)Math.PI) * 1.4F * var2;
