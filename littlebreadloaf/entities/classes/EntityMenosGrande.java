...
public class EntityMenosGrande extends EntityMob
{
    ...
    public void onDeath(DamageSource par1DamageSource)
    {
        ...
        if (par1DamageSource.getEntity() instanceof EntityPlayer)
        {
        	...
        	if(this.attackingPlayer.inventory.getCurrentItem() != null && this.attackingPlayer.inventory.getCurrentItem().itemID == Items.zanpakuto.itemID && props.getZTotal() < 75)
        	{
        		props.addPoints(8, 6);
        	}
