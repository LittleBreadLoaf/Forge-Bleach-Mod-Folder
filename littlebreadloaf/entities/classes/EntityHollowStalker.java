...
public class EntityHollowStalker extends EntityMob
{
	...
	public EntityHollowStalker(World par1)
	{
		this(par1, rand.nextInt(3));
	}
	public EntityHollowStalker(World par1World, int par2) 
	{
		super(par1World);
	...
	protected void dropFewItems(boolean par1, int par2)
	{
			 super.dropFewItems(par1, par2);
		        ...
		        {
		            this.dropItem(Armor.StalkerHelmet.itemID, 1);
		        }
    ...
    public void onDeath(DamageSource par1DamageSource)
    {
        ...
        if (par1DamageSource.getEntity() instanceof EntityPlayer)
        {
        	...
        	if(this.attackingPlayer.inventory.getCurrentItem() != null && this.attackingPlayer.inventory.getCurrentItem().itemID == Items.zanpakuto.itemID && props.getZTotal() < 80)
        	{
        		props.addPoints(8, 1);
        	}
