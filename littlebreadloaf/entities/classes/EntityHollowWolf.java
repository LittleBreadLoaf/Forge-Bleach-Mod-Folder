...
public class EntityHollowWolf extends EntityMob
{
	...
	public EntityHollowWolf(World par1)
	{
		this(par1, rand.nextInt(3));
	}

	public EntityHollowWolf(World par1World, int par2)
	{
		super(par1World);
		this.setTexture(par2);
		this.tasks.addTask(0, new EntityAISwimming(this));
		this.tasks.addTask(1, new EntityAIAttackOnCollide(this, EntityPlayer.class, 0.55D, false));
		this.tasks.addTask(2, new EntityAIAttackOnCollide(this, EntityWhole.class, 0.55D, false));
		this.tasks.addTask(3, new EntityAIAttackOnCollide(this, EntityShinigami.class, 0.55D, false));
		this.tasks.addTask(4, new EntityAIAvoidEntity(this, EntityIronGolem.class, 6.0F, 0.45F, 0.45F));
		this.tasks.addTask(5, new EntityAIMoveTowardsRestriction(this, 0.6D));
		this.tasks.addTask(6, new EntityAIWander(this, 0.45D));
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.followRange).setAttribute(70);
	...
	public void onDeath(DamageSource par1DamageSource)
	{
		...
		if (par1DamageSource.getEntity() instanceof EntityPlayer)
		{
			...
			if (props.getIsShinigami() && this.attackingPlayer.inventory.getCurrentItem() != null
					&& this.attackingPlayer.inventory.getCurrentItem().itemID == Items.zanpakuto.itemID && props.getZTotal() < 400)
			{
				props.addPoints(2, 5);
				props.addPoints(8, 2);
				props.addPoints(1, -2);
