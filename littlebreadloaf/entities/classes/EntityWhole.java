...
public class EntityWhole extends EntityMob
{
	...
	public EntityWhole(World par1World, int par2) 
	{
        ...
        this.tasks.addTask(3, new EntityAITempt(this, 0.4F, Items.zanpakuto.itemID, false));
...
@Override
        ...
        if (var2 != null && var2.itemID == Items.zanpakuto.itemID)
        {
            if (!this.worldObj.isRemote)
            {
                int var3 = 4 + this.rand.nextInt(3);
                    ...
                    this.entityDropItem(new ItemStack(Items.reiatsu, var3), 0.0F);
    ...
    {
    	int randomHollow = rand.nextInt(10);
