...
public class Names 
{
	...
	public static final String FisherHelmet_Name = "Hollow Mask";
	...
	public static final String PlayerMask10_Name = "Hollow Mask";
	public static final String PlayerMask10_UnlocalizedName = "playermask1";
	public static final String PlayerMask11_Name = "Hollow Mask";
	public static final String PlayerMask11_UnlocalizedName = "playermask1";
	public static final String PlayerMask12_Name = "Hollow Mask";
	public static final String PlayerMask12_UnlocalizedName = "playermask1";
	public static final String PlayerMask20_Name = "Hollow Mask";
	public static final String PlayerMask20_UnlocalizedName = "playermask2";
	public static final String PlayerMask21_Name = "Hollow Mask";
	public static final String PlayerMask21_UnlocalizedName = "playermask2";
	public static final String PlayerMask22_Name = "Hollow Mask";
	public static final String PlayerMask22_UnlocalizedName = "playermask2";
	public static final String PlayerMask30_Name = "Hollow Mask";
	public static final String PlayerMask30_UnlocalizedName = "playermask3";
	public static final String PlayerMask31_Name = "Hollow Mask";
	public static final String PlayerMask31_UnlocalizedName = "playermask3";
	public static final String PlayerMask32_Name = "Hollow Mask";
	public static final String PlayerMask32_UnlocalizedName = "playermask3";
	public static final String PlayerMask40_Name = "Hollow Mask";
	public static final String PlayerMask40_UnlocalizedName = "playermask4";
	public static final String PlayerMask41_Name = "Hollow Mask";
	...
	public static final String[] ShikaiIce_UnlocalizedName = {"shikai_ice1", "shikai_ice2", "shikai_ice3", "shikai_ice4", "shikai_ice5", "ice_cream", "zenhansha", "hi_yari"};
	public static final String[] ShikaiIce_Name = {"Ice Shikai", "Ice Shikai", "Ice Shikai", "Ice Shikai", "Ice Shikai", "Ice Shikai", "Zenhansha", "Hi-Yari"};
	...
	public static final String[] ShikaiLightning_UnlocalizedName = {"shikai_lightning1", "shikai_lightning2", "shikai_lightning3", "shikai_lightning4", "shikai_lightning5", "firebolt"};
	...
	public static final String[] ShikaiWater_UnlocalizedName = {"shikai_water1", "shikai_water2", "shikai_water3", "shikai_water4", "shikai_water5", "sakana"};
	public static final String[] ShikaiWater_Name = {"Water Shikai", "Water Shikai", "Water Shikai", "Water Shikai", "Water Shikai", "Water Shikai"};
	
	public static final String[] ShikaiNormal_UnlocalizedName = {"shikai_normal1", "shikai_normal2", "shikai_normal3", "shikai_normal4", "shikai_normal5", "ticonderoga", "setsuna"};
	public static final String[] ShikaiNormal_Name = {"Normal Shikai", "Normal Shikai", "Normal Shikai", "Normal Shikai", "Normal Shikai", "Normal Shikai", "Setsuna"};
