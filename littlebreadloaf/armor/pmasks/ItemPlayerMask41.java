...
public class ItemPlayerMask41 extends ItemArmor 
{

    @SideOnly(Side.CLIENT)
    private Icon theIcon;

	public ItemPlayerMask41(int par1, EnumArmorMaterial par2, int par3, int par4) 
	{
		super(par1, par2, par3, par4);
		this.setUnlocalizedName(Names.PlayerMask41_UnlocalizedName);
		this.setCreativeTab(Items.tabBleach);
		this.func_111206_d("LBLBM:playermask4");
