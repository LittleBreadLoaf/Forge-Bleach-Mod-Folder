...
public class ItemPlayerMask21 extends ItemArmor 
{

    @SideOnly(Side.CLIENT)
    private Icon theIcon;

	public ItemPlayerMask21(int par1, EnumArmorMaterial par2, int par3, int par4) 
	{
		super(par1, par2, par3, par4);
		this.setUnlocalizedName(Names.PlayerMask21_UnlocalizedName);
		this.setCreativeTab(null);
		this.setTextureName("LBLBM:playermask2");
	}
	...
	{
		return BleachModInfo.ID.toLowerCase() + ":textures/models/armor/player_mask2.png";
	}
	 @SideOnly(Side.CLIENT)
