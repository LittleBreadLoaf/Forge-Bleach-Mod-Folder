...
public class SoulSocietyChunkProvider implements IChunkProvider
{
	...
	public SoulSocietyChunkProvider(World world, long seed, boolean features)
	{
		this.worldObj = world;
	 ...
	 */
	public void generateTerrain(int par1, int par2, byte[] chunk)
	{
		byte miniChunk = 4;
		byte chunkSize = 16;
		byte seeLevel = 0;
...
//		
	...
	{
		return "SoulSocietyChunkProvider";
	}
