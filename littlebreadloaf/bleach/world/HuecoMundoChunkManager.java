...
{
	public BiomeGenBase[] huecoMundoBiomes = new BiomeGenBase[] { BleachBiomes.HuecoMundo };
	...
	protected HuecoMundoChunkManager()
	{
		...
		this.allowedBiomes.add(BleachBiomes.HuecoMundo);
	...
	public float[] getRainfall(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
	{
		...
		{
			float f = (float) this.huecoMundoBiomes[aint[i1] % this.huecoMundoBiomes.length].getIntRainfall() / 65536.0F;
	...
	public float[] getTemperatures(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
	{
		...
		for (int i1 = 0; i1 < par4 * par5; ++i1)
		{
			float f = (float) this.huecoMundoBiomes[aint[i1] % this.huecoMundoBiomes.length].getIntTemperature() / 65536.0F;
