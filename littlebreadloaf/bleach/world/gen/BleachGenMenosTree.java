		...
		for (int x = -radius; x <= radius; x++)
		{
			for (int z = -radius; z <= radius; z++)
			{
				for(int y = this.seeLevel; y < 25; y++)
				{
					...
					{
					world.setBlock(x+i, y, z+k, BleachBlocks.soulQuartzBlock.blockID);
					world.setBlock(x+i, y+ random.nextInt(2), z+k, BleachBlocks.soulQuartzBlock.blockID);
					world.setBlock(x+i, y+ random.nextInt(3), z+k, BleachBlocks.soulQuartzBlock.blockID);
					world.setBlock(x+i, y+ random.nextInt(3), z+k, BleachBlocks.soulQuartzBlock.blockID);
					world.setBlock(x+i, y+ random.nextInt(4), z+k, BleachBlocks.soulQuartzBlock.blockID); 
					}
				}
			}
		}
					...
					if(Math.sqrt(z*z + x*x) <= radius)
					{
						...
						if(random.nextInt(30) == 0)
						{
							...
							for(int b = 0; b < length; ++b)
							{
								blockX += directionX;
								blockZ += directionZ;
								world.setBlock(blockX, y, blockZ, BleachBlocks.soulQuartzBlock.blockID);
