...
public class GuiFaction extends GuiScreen {
	...
	public void actionPerformed(GuiButton button) {
		...
		case 0:
				player.sendQueue.addToSendQueue(FlashPacket.getPacket((byte)11)); 
		...
		case 1: 
				player.sendQueue.addToSendQueue(FlashPacket.getPacket((byte)12)); 
		...
		case 3:
				player.sendQueue.addToSendQueue(FlashPacket.getPacket((byte)13)); 
